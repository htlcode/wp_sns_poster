<div class="wrap">
	<h1><?php echo __("Schedules list",WP_OTO_POSTER) ?></h1>
		...
		<table border="1">
			<thead>
				<tr>
					...
					<td><?php echo __('Url',WP_OTO_POSTER); ?></td>
			...
			<?php foreach($records as $record): ?>
				<?php
				$edit_link = get_site_url().'/wp-admin/admin.php?page=wp_oto_poster_schedule&id='.$record['id'];
				$delete_link = get_site_url().'/wp-admin/admin.php?page=wp_oto_poster_schedules&delete='.$record['id'];
				?>
				<tr>
